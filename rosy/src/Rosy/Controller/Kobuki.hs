...
data BumperLeft = BumperLeft
    { bumpL :: Bool -- | 'True' for pressed, 'False' for released
    } deriving (Show, Eq, Ord, Typeable, G.Generic)
...
data BumperCenter = BumperCenter
    { bumpC :: Bool -- | 'True' for pressed, 'False' for released
    } deriving (Show, Eq, Ord, Typeable, G.Generic)
...
data BumperRight = BumperRight
    { bumpR :: Bool -- | 'True' for pressed, 'False' for released
    } deriving (Show, Eq, Ord, Typeable, G.Generic)
...
data CliffLeft = CliffLeft
    { cliffL :: Bool -- | 'True' for approaching, 'False' for moving away
    } deriving (Show, Eq, Ord, Typeable, G.Generic)
...
data CliffCenter = CliffCenter
    { cliffC :: Bool -- | 'True' for approaching, 'False' for moving away
    } deriving (Show, Eq, Ord, Typeable, G.Generic)
...
data CliffRight = CliffRight
    { cliffR :: Bool -- | 'True' for approaching, 'False' for moving away
    } deriving (Show, Eq, Ord, Typeable, G.Generic)
